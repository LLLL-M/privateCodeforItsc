...
int setProgramTableInfo(stProgramTable *pstProgramTable, int num)
{
    ...
    log_debug("%s  nSchemeID  %d  cycleTime  %d  greenRationId  %d  offset  %d  phaseTurnId  %d \n ",__func__,
...
{		//读取配置文件参数
    ...
    pstTimeBasedActionTable->ProgramNo = gSignalControlpara->stAction[num - 1].nSchemeID;
