...
void udp_server_process()
{
    ...
    while(1)
    {
        ...
        else
        {
			...
			//设置信号机型号，DS-TSC300-44或者DS-TSC300-22
			else if(udp_info.iHead == 0x6e6e && udp_info.iType == 0xbe)
			{
			...
			//获取信号机型号，DS-TSC300-44或者DS-TSC300-22
			else if(udp_info.iHead == 0x6e6e && udp_info.iType == 0xbf)
			{
