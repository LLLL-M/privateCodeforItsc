...
*****************************************************************************/
void ReadPhaseItem(PPhaseItem item, struct STRU_SignalTransEntry *entry, int num,int no)
{
    ...
    for(i = 0 ; i < num; i++)
    {
        sprintf(cSection,"PhaseItem%d_%d",no,i+1);
...
void ReadChannelItem(PChannelItem item, int num,int no)
{
    if(NULL == item)
    {
        return;
    ...
    for(i = 0 ; i < num; i++)
    {
        sprintf(cSection,"ChannelItem%d_%d",no,i+1);
...
void ReadActionItem(PActionItem item, int num)
{
    ...
    for(i = 0 ; i < num; i++)
    {
        ...
        item[i].nSchemeID = get_one_value(cSection,"nSchemeID");
        item[i].nPhaseTableID = get_one_value(cSection,"nPhaseTableID");
        item[i].nChannelTableID = get_one_value(cSection,"nChannelTableID");
...
*****************************************************************************/
void ReadFollowPhaseItem(PFollowPhaseItem item, int num,int no)
{
    int i = 0;
    char cSection[MAX_SECTION_LEN] = {0};
    ...
    for(i = 0 ; i < num; i++)
    {
        sprintf(cSection,"FollowPhaseItem%d_%d",no,i+1);
