...
#define bmemdup(B_ARGS, p, s) bmemdupNoBalloc(p, s)     /* Added by lxp to support binary file upload. */
...
#define bmemdup(B_ARGS, p, s) bmemdup(p, s)             /* Added by lxp to support binary file upload. */
...
extern char_t   *bmemdup(B_ARGS_DEC, char_t *s, int size);      /* Added by lxp to support binary file upload. */
...
extern char_t   *xmemstr(char_t *memBlk, char_t *find, int memSize);        /* Added by lxp to support binary file upload. */
