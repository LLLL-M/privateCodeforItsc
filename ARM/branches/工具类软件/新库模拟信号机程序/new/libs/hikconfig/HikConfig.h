...
extern void ReadChannelItem(PChannelItem item, int num,int no);
extern void ReadFollowPhaseItem(PFollowPhaseItem item, int num,int no);
...
extern void ReadPhaseItem(PPhaseItem item, struct STRU_SignalTransEntry *entry, int num,int no);
...
extern void WriteChannelItem(PChannelItem item,int no);
extern Boolean WriteConfigFile(SignalControllerPara *param, const char *path);
extern void WriteFollowPhaseItem(PFollowPhaseItem item,int no);
...
extern void WritePhaseItem(PPhaseItem item, struct STRU_SignalTransEntry *entry,int no);
