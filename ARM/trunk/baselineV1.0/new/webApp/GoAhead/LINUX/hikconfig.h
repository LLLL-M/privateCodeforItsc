...
extern int LoadDataFromCfg(SignalControllerPara *pSignalControlpara, const char *path);
...
/*Write*/
extern int WriteConfigFile(SignalControllerPara *param, const char *path);
