...
extern unsigned short LoadDataFromCfg(SignalControllerPara *pSignalControlpara, const char *path);
extern void WriteConfigFile(SignalControllerPara *param, const char *path);
extern void WriteUnitPara(PUnitPara item);
extern void WritePhaseItem(PPhaseItem item, struct STRU_SignalTransEntry *entry, int num);
extern void WritePhaseTurnItem(PhaseTurnItem *item, int num);
extern void WriteGreenSignalRationItem(GreenSignalRationItem *item, int num);
extern void WriteChannelItem(PChannelItem item, int num);
extern void WriteSchemeItem(PSchemeItem item, int num);
extern void WriteActionItem(PActionItem item, int num);
extern void WriteTimeIntervalItem(TimeIntervalItem *item, int num);
extern void WritePlanSchedule(PPlanScheduleItem item, int num);
extern void WriteFollowPhaseItem(PFollowPhaseItem item, int num);
extern void WriteVehicleDetector(struct STRU_N_VehicleDetector *item, int num);
extern void WritePedestrianDetector(struct STRU_N_PedestrianDetector *item, int num);
