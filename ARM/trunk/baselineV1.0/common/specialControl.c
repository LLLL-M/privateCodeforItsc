...
static unsigned char cArrayMsgInduction[47] = {0x30, 0x2D, 0x02, 0x01, 0x00, 0x04, 0x06, 0x70,
                                    0x75, 0x62, 0x6C, 0x69, 0x63, 0xA3, 0x20, 0x02, 
                                    0x01, 0x1B, 0x02, 0x01, 0x00, 0x02, 0x01, 
                                    0x00, 0x30, 0x15, 0x30, 0x13, 0x06, 0x0D, 0x2B, 
                                    0x06, 0x01, 0x04, 0x01, 0x89, 0x36, 0x04, 0x02, 
                                    0x01, 0x04, 0x0E, 0x00, 0x02, 0x02, 0x00, 0xFE};

static unsigned char cArrayMsgSystem[46] = {0x30, 0x2C, 0x02, 0x01, 0x00, 0x04, 0x06, 0x70,
...
static unsigned char cArrayMsgManual[46] = {0x30, 0x2C, 0x02, 0x01, 0x00, 0x04, 0x06, 0x70,
        							  0x75, 0x62, 0x6C, 0x69, 0x63, 0xA3, 0x1F, 0x02,
        							  0x01, 0x09, 0x02, 0x01, 0x00, 0x02, 0x01, 0x00,
        							  0x30, 0x14, 0x30, 0x12, 0x06, 0x0D, 0x2B, 0x06, 
        							  0x01, 0x04, 0x01, 0x89, 0x36, 0x04, 0x02, 0x01, 
        							  0x04, 0x0E, 0x00, 0x02, 0x01, 0x01};
...
void SendSpecialCtrolUdpMsg(unsigned char cControlType)
{
    ...
    switch(cControlType)
    {
        ...
        default:                             cArrayMsgManual[45]=cControlType;  pMsg = cArrayMsgManual;                  cMsgLen = sizeof(cArrayMsgManual);          break;
    }
	...
	INFO("SendUdpMsg  succeed  ,cControlType  :  %d\n",cControlType);
	close(socketFd);
}
