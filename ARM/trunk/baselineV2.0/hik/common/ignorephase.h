extern UInt8 gIgnoreOption;

static void SetBarrier(CalInfo *calInfo, UInt8 stageNO)
{
...
UNUSEDATTR static void PrintStageInfo(CalInfo *calInfo)
{
	int i, ring;
	StageInfo *stageInfos = calInfo->stageInfos;
...
static void CalStageInfo(CalInfo *calInfo)
{
	int i = 0, ring = 0;
    UInt8 nPhaseId = 0;
...
static inline Boolean IsStageIgnore(CalInfo *calInfo, StageInfo *s)
{
	int i, n = 0;
...
static void AdjustPhaseIncludeStage(CalInfo *calInfo, UInt8 ignoreStageNO)
{
	int i, j;
...
static UInt8 FindPrevPhase(CalInfo *calInfo, UInt8 ignorePhaseId)
{
	int i, index, ring = gRunConfigPara->stPhase[calInfo->phaseTableId - 1][ignorePhaseId - 1].nCircleID;
	UInt8 prevPhase = 0;
...
static UInt8 FindNextPhase(CalInfo *calInfo, UInt8 ignorePhaseId)
{
	int i, index, ring = gRunConfigPara->stPhase[calInfo->phaseTableId - 1][ignorePhaseId - 1].nCircleID;
	UInt8 nextPhase = 0;
...
static inline void AdjustIgnorePhaseTime(CalInfo *calInfo, UInt8 prevPhase, UInt8 nextPhase, UInt8 ignorePhase)
{
	PhaseTimeInfo *times = NULL;
