...
//信号机软件程序版本硬件版本
#define SOFTWARE_VERSION_INFO "HIKETSC-V1.0.0.1-2015.03.16"
...
extern void get_custom_params();
extern void get_desc_params();
extern void get_special_params();
extern void set_custom_params();
extern void set_desc_params();
extern void set_failure_number(unsigned int failurenumber);
extern void set_special_params();
