...
*****************************************************************************/
static void SetCountValueLaiSiStandard(unsigned char iTempPassTime[2],unsigned char cDeviceId)
{
...
void countDownByLaiSiProtocol()
{
    ...
    for(i = 0; i < MAX_NUM_COUNTDOWN_LAISI; i++)
    {
        ...
        SetCountValueLaiSiStandard(iTempPassTime,g_CountDownCfg.cDeviceId[i]);
